...
public class MingTeacherAdapter extends RecyclerView.Adapter<MingTeacherAdapter.ViewHolder>{
    ...
    @Override
    public MingTeacherAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(MingTeacherAdapter.ViewHolder holder, final int position) {
